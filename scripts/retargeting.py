...
parser.add_argument("--deactivate_closer_legs", help="Deactivate closer legs enforcing.", action="store_true")
...
closer_legs = not args.deactivate_closer_legs
